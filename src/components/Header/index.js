  ...
  <nav className="row pb3 w-100 flex-m flex-l pa4-m pa5-l flex-row items-center justify-between">
    ...
    <div className="right flex items-center justify-center justify-end-ns">
      <div className="flex ph4-ns">
        ...
        <Link className="text-link no-underline f6 athelas ttc pa2 pa3-ns pb2-ns gray-4" to="/blog">blog</Link>
      ...
      <a href="www.linkedin.com/in/contactmihaip" className="gray-4 h-100 flex flex-column justify-center items-center">
